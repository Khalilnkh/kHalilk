                ...
                if (result)
                {
                    ...
                    Count: ConsoleHelper.WriteTextWithColor(ConsoleColor.Gray, "Please, enter drug count");
                        ...
                        if (result)
                        {
                            ...
                            {
                                ConsoleHelper.WriteTextWithColor(ConsoleColor.DarkRed, "Plese enter correct number");
                                goto Count;
                            }
                            if (dbCount == 0)
                            {
                                ConsoleHelper.WriteTextWithColor(ConsoleColor.DarkRed, "something went wrong");
                                goto Count;
                        ...
                        {
                            ConsoleHelper.WriteTextWithColor(ConsoleColor.DarkRed, "Please, enter numebr in correct format");
                            goto Count;
                        }
